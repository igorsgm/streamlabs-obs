...
export class SupporterGoalService extends GenericGoalService {
  ...
  getApiSettings() {
    return {
      ...
      previewUrl: `http://${this.getHost()}/widgets/supporter-goal?token=${this.getWidgetToken()}`,
      dataFetchUrl: `http://${this.getHost()}/api/v5/slobs/widget/supportergoal/settings`,
      settingsSaveUrl: `http://${this.getHost()}/api/v5/slobs/widget/supportergoal/settings`,
      goalUrl: `http://${this.getHost()}/api/v5/slobs/widget/supportergoal`,
