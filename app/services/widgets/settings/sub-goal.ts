...
export class SubGoalService extends GenericGoalService {
  ...
  getApiSettings() {
    return {
      ...
      dataFetchUrl: `http://${this.getHost()}/api/v5/slobs/widget/subgoal/settings`,
      previewUrl: `http://${this.getHost()}/widgets/sub-goal?token=${this.getWidgetToken()}`,
      settingsSaveUrl: `http://${this.getHost()}/api/v5/slobs/widget/subgoal/settings`,
      goalUrl: `http://${this.getHost()}/api/v5/slobs/widget/subgoal`,
