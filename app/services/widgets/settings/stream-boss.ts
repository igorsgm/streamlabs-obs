...
> {
  ...
  getApiSettings() {
    return {
      ...
      previewUrl: `http://${this.getHost()}/widgets/streamboss?token=${this.getWidgetToken()}`,
      settingsUpdateEvent: 'streambossSettingsUpdate',
      goalCreateEvent: 'newStreamboss',
      goalResetEvent: 'streambossEnd',
      dataFetchUrl: `http://${this.getHost()}/api/v5/slobs/widget/streamboss/settings`,
      settingsSaveUrl: `http://${this.getHost()}/api/v5/slobs/widget/streamboss/settings`,
      goalUrl: `http://${this.getHost()}/api/v5/slobs/widget/streamboss`,
